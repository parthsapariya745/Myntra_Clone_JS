...
function searchProduct() {
    ...
    <div class="w-[220px] border border-gray-200 px-4 py-5 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 text-center group">
        ...
        <button class="mt-3 w-full px-4 py-2 cursor-pointer bg-[#ff1b58] hover:bg-[#ff0095] text-white text-sm rounded-md transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-opacity-50" onclick="addProduct(${p.id})">
            Add to Cart
        </button>
    </div>
    `).join("");
